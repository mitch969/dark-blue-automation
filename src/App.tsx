...
import IntegrationAI from "./pages/services/IntegrationAI";
import SitesWeb from "./pages/services/SitesWeb";
    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/services/integration-ai" element={<IntegrationAI />} />
